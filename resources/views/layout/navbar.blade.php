...
-->
    ...
    <nav class="navbar fixed-top background-white" id="mainNav" style="height: 9%">
                ...
                <div class="col-md-12 text-right" style="margin-top: 1%; margin-left:30%">
                    ...
                    <div class="navbar-expand-lg" id="navbarResponsive">
                        <ul class="navbar-nav">
                            ...
                            <li hidden class="nav-item dropdown"style="margin-right: 25px;" id="openModalServicos">
                                <a class="nav-link" style="" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <b>SERVIÇOS</b>
                                </a>
                                <div id="myModalServicos" class="modal">
                                    <div class="modal-content" style="margin-top:4.2%;  background-color: #5b7bfd">
                                        <span hidden class="close" id="closeModalServicos">&times;</span>

                                        <div class="row" style="padding-left: 5%">                                           
                                            <div class="col-lg-4 col-md-2" style="text-align: left; color:white; font-size: 23px">
                                                <b>SOFTWARES</b>
