    ...
    <div>
        ...
        <section class="section" style="color:black; padding-top: 11%; padding-bottom: 6%;">		
            <div class="row" style="padding-left: 5%">
                ...
                <div class="col-md-6">
                    <h3 style="flex: 0 0 45%; color: rgb(38, 128, 235); font-size:48px; font-family: 'Gothic A1', sans-serif;">                        
                        Soluções para automatizar processos  manuais e fornecer informações em tempo real para tomada de decisão                        								
                    </h3>

                    <p style="color:black; font-size:26px; width: 80%; font-family: 'Gothic A1', sans-serif;">
        ...
        <section class="section" style="padding: 0px 0px; background-color:#8abce6; height: 776px;">		
            <div class="row" style="padding-left: 5%">                             
                ...
                <div class="col-md-6" style="padding-left: 6%;">
                    <h3 class="animated-element margin-bottom-20" style="padding-top: 20%; width:70%; color:white; font-size:44px;">                        
                        Tome decisões com base em dados reias que farão o seu negócio prosperar                       							
                    </h3>

                    <p class="animated-element slow margin-bottom-20" style="color:black; font-size:25px; width:60%;">
        ...
        <section class="section padding" style="background-color: rgb(246, 246, 246); padding-top: 4%; padding-bottom: 15%; height: 850px;">
            <div class="padding">
                <div class="text-center" style="padding-bottom: 4%">
                    <h3 class="section-subheading" style="color:#3d3dff;  padding-left: 30%; padding-right: 30%; font-size:44px;">
                        Um conjunto de soluções, prontas para entregar os resultados que você procura
                    </h3>
                </div>
                ...
                <div class="row text-center" style="margin-left: 5%; margin-right: 5%">
                    <div class="col-lg-3 col-md-4">                             
                        ...
                        <div class="text-justify solucoes fundo" style="background-color: white; border: 1px solid #cfc9c9; width: 65%; padding-bottom: 75px;">
                            <h6 style="padding-right: 20%; padding-left: 25%; font-size: 15pt;">Vendas</h6> 
                            <h6 style="padding-right: 20%; padding-left: 25%; font-size: 15pt;">Inventário</h6> 
                            <h6 style="padding-right: 20%; padding-left: 25%; font-size: 15pt;">Compras</h6> 
                            <h6 style="padding-right: 20%; padding-left: 25%; font-size: 15pt;">Encomendas</h6> 
                    ...
                    <div class="col-lg-3 col-md-4">                          
                        ...
                        <div class="text-justify equal-column fundo" style="background-color: white; border: 1px solid #cfc9c9; width: 65%; margin: 0 15.5%; padding: 5% 0;">
                            <h6 style="padding-top: 5%; padding-right: 10%; padding-left: 15%; font-size: 15pt;">Tesouraria Contas/C</h6> 
                            <h6 style="padding-right: 10%; padding-left: 15%; font-size: 15pt;">Tesouraria Bancos</h6> 
                            <h6 style="padding-right: 10%; padding-left: 15%; font-size: 15pt;">Contabilidade Base</h6> 
                            <h6 style="padding-right: 10%; padding-left: 15%; font-size: 15pt;">Contabilidade Gestão</h6> 
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">                          
                        ...
                        <div class="text-justify equal-column fundo" style="background-color: white; border: 1px solid #cfc9c9; width: 75%; margin: 0 12.5%; height: 58%;">
                            <h6 style="padding-top: 7%; padding-right: 5%; padding-left: 15%; font-size: 15pt;">Salário / Honorários</h6> 
                            <h6 style="padding-right: 5%; padding-left: 15%; font-size: 15pt;">Gestão de contratos</h6> 
                            <h6 style="padding-right: 5%; padding-left: 15%; font-size: 15pt;">Processamento</h6> 
                            <h6 style="padding-right: 5%; padding-left: 15%; font-size: 15pt;">Operações financeiras</h6> 
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">                         
                        ...
                        <div class="text-justify equal-column fundo" style="background-color: white; border: 1px solid #cfc9c9; width: 80%; margin: 0 10%; height: 58%;">
                            <h6 style="padding-top: 25%; padding-left: 35%; font-size: 15pt;">Activos</h6> 
                        </div>
                    </div>
                </div>

                <a href="#" class="circle btn-center text-center" style="font-size:20px; background-color:#1663BF; width: 20%; margin-top: 2.5%; color: white; padding-top: 10px">
        ...
        <section class="section" style="background-color:#8abce6;">
            <div class="container padding">
                <div class="text-center">
                    <h2 class="section-subheading" style="color:white; font-size: 40px">Nossos clientes de referência</h2>
                </div>
                ...
                <div class="row text-center padding">
                    <div class="col-lg-2 col-md-2"  style="text-align: -webkit-center;">                    
                        ...
                        <p style="color: #5A5A5A; font-size: 15pt; padding-top: 15px;">Sector Público</p>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-2" style="text-align: -webkit-center;">
                        ...
                        <p style="color: #5A5A5A; font-size: 15pt; padding-top: 15px;">Indústria</p>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-2">
                        ...
                        <p style="color: #5A5A5A; font-size: 15pt; padding-top: 15px;">Construção</p>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-2">
                        ...
                        <p style="color: #5A5A5A; font-size: 15pt; padding-top: 15px;">Telecomunicações</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section" style="background-color:rgb(246, 246, 246); padding: 0rem 1rem;">
            <div class="line" style="padding: 3rem 1.25rem;">
                ...
                <div class="text-center" style="padding-left: 20%; background-color: transparent;">                    
                    <img class="img-fluid rounded-circle" src="/img/home/face.png" alt="..." style="width: 40%; padding-left: 32%; display: flex; justify-content: center;"/>                     
                </div>
