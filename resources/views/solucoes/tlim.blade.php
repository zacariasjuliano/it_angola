...
@section('content')
    ...
    <div class="container" style="background-color: white; height: 540px; position: relative; padding-top: 5%;">        
        <div style="flex: 1; padding-top: 2.5%;">
            ...
            <p style="font-size: 23px; color: black; text-align: -webkit-left; padding-left: 9%; padding-right: 9%;">
    ...
    <div style="background-color: #8abce6; height: 1150px; position: relative; padding: 0% 0%">
        ...
        <div style="flex: 1; padding-left: 0%; padding-top: 7%;">
            ...
            <p style="font-size: 25px; color: white; text-align: -webkit-left; padding: 0% 22%; word-spacing: 10px;">
                Aumente a eficiência do seu negócio com a solução de frente de loja Tlim. <br>Organize facilmente a 
    ...
    <div style="background-color: #b2b2b2; height: 850px; position: center; padding-top: 6.5%">  
        <div style="display: flex; justify-content: center; align-items: center">
            ...
            <div style="text-align: center; border-radius: 25px; background-color: white; padding-top: 2.5%; margin-right: 1%; width:25%; height:600px">
                <h5 style="font-size:30px; color: blue; padding-top: 4%"><b>TLIM EASY</b></h5>
                ...
                <ul style="text-align: left; padding-bottom: 11%;">
            ...
            <div style="text-align: center; border-radius: 25px; background-color: white; padding-top: 5%; margin-left: 1%; width:25%; height:600px">
                <div class="circle3" style="background-color: green;">
                    ...
                    <p style="font-size:20px; color: white; padding-top: 1%"><b>RECOMENDADOS</b></p>
                </div>

                <h5 style="font-size:30px; color: blue; margin-top: -5%; margin-bottom: 10%"><b>TLIM</b></h5>
