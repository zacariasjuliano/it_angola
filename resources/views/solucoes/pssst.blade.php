...
@section('content')
    ...
    <div id="carouselExample" class="carousel slide" data-ride="carousel" style="padding-top: 2.5%">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-center-text" style="text-align: -webkit-center;">
                ...
                <p style="font-size:50px; color: white" class="padding"><b>PSSST</b></p>
    ...
    <div style="margin-bottom: 2%; margin-top: 3%; background-color: white;">
        ...
        <div class="container" style="padding-top: 2.5%">
            <div class="row" style="border-radius: 0px; border: 0px solid #000; justify-content: space-between">
                <a href="#" class="col-2 text-center menu_activo" style="max-width: 10%; background-color:rgb(35, 35, 245); color: white">  
                    <b>MÓDULOS</b>        
                </a>
                <a href="#" class="col-2 text-center" style="max-width: 10%; background-color: rgb(92, 50, 50); color: white">  
                    <b>STOCKS</b>        
                </a>
                <a href="#" class="col-2 text-center" style="max-width: 18%; background-color: rgb(92, 50, 50); color: white">  
                    <b>PREÇOS PEDIDOS</b>        
                </a>
                <a href="#" class="col-2 text-center" style="max-width: 10%; background-color: rgb(92, 50, 50); color: white">  
                    <b>CAIXA</b>        
                </a>    
                <a href="#" class="col-4 text-center menu_curvo" style="max-width: 12%; background-color: rgb(92, 50, 50); color: white">  
                    <b>FIDELIZAÇÃO</b>       
                </a>  
                <a href="#" class="col-4 text-center menu_curvo" style="max-width: 11%; background-color: rgb(92, 50, 50); color: white">  
                    <b>CONTROLO</b>       
                </a>   
                <a href="#" class="col-4 text-center menu_curvo" style="max-width: 14%; background-color: rgb(92, 50, 50);; color: white">  
                    <b>INTERATIVIDADE</b>       
                </a> 
            </div>         
        </div>
    ...
    <div style="background-color: rgb(5, 5, 65); height: 650px; position: relative; padding: 0% 0%">
        ...
        <div class="contanier" style="flex: 1; padding-top: 5%;">
            <p style="font-size: 35px; color: white; text-align: -webkit-center;"><b>Ative o seu negócio com o Pssst!</b></p>
            <p class="padding" style="font-size: 35px; color: white; text-align: -webkit-center;"><b>Dê um grande impulso aos resultados com esta solução inovadora 
    ...
    <div style="background-color: rgb(92, 50, 50); height: 600px; position: relative; padding: 0% 0%">
        
        <div class="contanier " style="flex: 1; padding: 4%; 5%">
            <p style="font-size: 35px; color: white; text-align: -webkit-center;"><b>Tipos De Acesso A Esta Solução</b></p> 
    ...
    <div style="background-color: white; height: 690px; position: relative; padding: 0% 0%">
        
        <div class="contanier padding" style="flex: 1; padding-top: 4%;">
            <p style="font-size: 35px; color: black; text-align: -webkit-center; padding-top: 4%;"><b>Ofereça um serviço rápido e eficiente</b></p>
            ...
            <div style="text-align: -webkit-center;">
                <img class="img-fluid" src="/img/solucoes/231.png" alt="..." style="width: 25%"/>  
            </div>
    ...
    <div style="background-color: #b2b2b2; height: 850px; position: center; padding-top: 6.5%">        
        ...
        <div style="display: flex; justify-content: center; align-items: center">
            ...
            <div style="text-align: center; border-radius: 25px; background-color: white; padding-top: 5%; margin-right: 1%; width:25%; height:600px">
                <p style="font-size:30px; color: blue;"><b>PSSST EASY</b></p>
            ...
            <div style="text-align: center; border-radius: 25px; background-color: white; padding-top: 5%; margin-left: 1%; width:25%; height:600px">
                ...
                <p style="font-size:30px; color: blue;"><b>PSSST</b></p>
