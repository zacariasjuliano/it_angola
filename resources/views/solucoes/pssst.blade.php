...
@section('content')
    ...
    <div style="margin-bottom: 2%; margin-top: 1%;">
        ...
        <div style="padding: 0 15% 3.5% 15%;">        
            <div class="card-deck mb-3" >
                <div class="card mb-4 padding" style="background-color: rgb(92, 50, 50); margin-left: 0px; margin-right: -3px; border-radius: 25px 0 0 0; border: 0">
                ...
                <div class="card mb-4 padding" style="background-color: rgb(92, 50, 50); margin-left: -3px; margin-right: -3px; border: 0">
                    <h5 class="text-center" style="font-size: 30px; color: white; padding-top: 3%">
                        Preços
                    </h5> 
                    <p style="font-size: 15px; color: white; line-height: 30px; padding: 0 12%">
                ...
                <div class="card mb-4 padding" style="background-color: rgb(92, 50, 50); margin-left: -3px; margin-right: -3px; border-radius: 0 25px 0 0; border: 0">
            ...
            <div class="card-deck mb-3" style="margin-bottom: -3rem!important; margin-top: -3rem!important;">
                <div class="card mb-4 padding" style="background-color: rgb(92, 50, 50); margin-left: 0px; margin-right: -3px; margin-top: -5%; border: 0">
                    <h5 class="text-center" style="font-size: 30px; color: white; padding-top: 0%">
                        Caixa
                    </h5> 
                    <p style="font-size: 15px; color: white; line-height: 30px; padding: 0 12%">
            ...
            <div class="card-deck mb-3" style="margin-bottom: -3rem!important; margin-top: -3rem!important;">
                <div class="card mb-4 padding" style="background-color: rgb(92, 50, 50); margin-left: 0px; margin-right: -3px; border-radius: 0 0 0 25px; border: 0">
                    <h5 class="text-center" style="font-size: 30px; color: white; padding-top: 0%">
                        Interatividade
                    </h5> 
                    <p style="font-size: 15px; color: white; line-height: 30px; padding: 0 12%">
                ...
                <div class="card mb-4 padding" style="background-color: rgb(92, 50, 50); margin-left: 0px; margin-right: -3px; border: 0">
                ...
                <div class="card mb-4 padding" style="background-color: rgb(92, 50, 50); margin-left: 0px; margin-right: -3px; border-radius: 0 0 25px 0; border: 0">
                    <p class="text-center" style="font-size: 30px; color: white; padding-top: 0%">                        
                    </p> 
                    <p class="padding" style="font-size: 15px; color: white;">
                    </p>  
    ...
    <div style="background-color: rgb(5, 5, 65); height: 650px; position: relative; padding: 0% 0%">
        ...
        <div class="contanier" style="flex: 1; padding-top: 5%;">
            ...
            <p style="font-size: 30px; color: white; text-align: -webkit-left; padding: 1% 24%"><b>Dê um grande impulso aos resultados com esta solução inovadora 
                de POS (ponto de venda):</b></p>  

            <ul style="text-align: left; color: white; padding-left: 26%">
    ...
    <div style="background-color: rgb(92, 50, 50); height: 700px; position: relative; padding: 0% 0%">
        
        <div class="contanier " style="flex: 1; padding: 6%;">
            <h5 style="font-size: 35px; color: white; text-align: -webkit-center;"><b>Tipos De Acesso A Esta Solução</b></h5> 
            <p style="font-size: 25px; color: white; text-align: -webkit-left; padding: 3% 23.5%">
            ...
            <p style="font-size: 25px; color: white; text-align: -webkit-left; padding: 0 23.5%">
    ...
    <div style="background-color: white; height: 1090px; position: relative; padding: 0% 0%">
        ...
        <div class="contanier padding">
            ...
            <p style="font-size: 25px; color: black; text-align: -webkit-left; padding: 0% 24%">
    ...
    <div style="background-color: #b2b2b2; height: 770px; position: center; padding-top: 5%">        
        ...
        <div style="display: flex; justify-content: center; align-items: center">
            ...
            <div style="text-align: center; border-radius: 25px; background-color: white; padding-top: 2.5%; margin-right: 1%; width:25%; height:600px">
                <h5 style="font-size:30px; color: blue; padding-top: 5%"><b>PSSST EASY</b></h5>
                ...
                <ul style="text-align: left; color: rgb(92, 50, 50); padding-bottom: 11%;">
            ...
            <div style="text-align: center; border-radius: 25px; background-color: white; padding-top: 5%; margin-left: 1%; width:25%; height:600px">
                <div class="circle3" style="background-color: rgb(92, 50, 50);">
                    ...
                    <p style="font-size:20px; color: white; padding-top: 0.5%"><b>RECOMENDADOS</b></p>
                </div>

                <h5 style="font-size:30px; color: blue; margin-top: -5%; margin-bottom: 10%"><b>PSSST</b></h5>
